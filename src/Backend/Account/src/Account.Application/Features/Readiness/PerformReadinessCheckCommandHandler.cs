...
{
    public class
        PerformReadinessCheckCommandHandler : IRequestHandler<PerformReadinessCheckCommand, CommandResult<string>>
    {
        ...
        public async Task<CommandResult<string>> Handle(PerformReadinessCheckCommand command,
            CancellationToken cancellationToken)
        {
            ...
            foreach (var property in type.GetProperties())
            {
                ...
                {
                    return new CommandResult<string>(result: $"Configuration Error. Property {property.Name} is null.",
