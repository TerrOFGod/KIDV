...
const AssumeRoleWithWebIdentityRequestFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.WebIdentityToken && { WebIdentityToken: constants.SENSITIVE_STRING }),
});
...
// EXTERNAL MODULE: ../../node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/parseXmlBody.js + 12 modules
var parseXmlBody = __webpack_require__(2615);
...
var extended_encode_uri_component = __webpack_require__(2622);
...
const de_ExpiredTokenExceptionRes = async (parsedOutput, context) => {
    ...
    return (0,exceptions.decorateServiceException)(exception, body);
};
...
const de_AssumedRoleUser = (output, context) => {
    const contents = {};
    if (output[_ARI] != null) {
        contents[_ARI] = (0,parse_utils.expectString)(output[_ARI]);
    }
    if (output[_Ar] != null) {
        contents[_Ar] = (0,parse_utils.expectString)(output[_Ar]);
    }
    return contents;
};
const de_AssumeRoleResponse = (output, context) => {
    ...
    if (output[_PPS] != null) {
        contents[_PPS] = (0,parse_utils.strictParseInt32)(output[_PPS]);
    }
    if (output[_SI] != null) {
        contents[_SI] = (0,parse_utils.expectString)(output[_SI]);
    }
    return contents;
};
const de_AssumeRoleWithWebIdentityResponse = (output, context) => {
    ...
    if (output[_SFWIT] != null) {
        contents[_SFWIT] = (0,parse_utils.expectString)(output[_SFWIT]);
    }
    if (output[_ARU] != null) {
        contents[_ARU] = de_AssumedRoleUser(output[_ARU], context);
    }
    ...
    if (output[_Pr] != null) {
        contents[_Pr] = (0,parse_utils.expectString)(output[_Pr]);
    }
    if (output[_Au] != null) {
        contents[_Au] = (0,parse_utils.expectString)(output[_Au]);
    }
    if (output[_SI] != null) {
        contents[_SI] = (0,parse_utils.expectString)(output[_SI]);
    }
...
const de_Credentials = (output, context) => {
    const contents = {};
    if (output[_AKI] != null) {
        contents[_AKI] = (0,parse_utils.expectString)(output[_AKI]);
    }
    if (output[_SAK] != null) {
        contents[_SAK] = (0,parse_utils.expectString)(output[_SAK]);
    }
    if (output[_ST] != null) {
        contents[_ST] = (0,parse_utils.expectString)(output[_ST]);
    }
    if (output[_E] != null) {
        contents[_E] = (0,parse_utils.expectNonNull)((0,date_utils.parseRfc3339DateTimeWithOffset)(output[_E]));
    }
    return contents;
};
const de_ExpiredTokenException = (output, context) => {
    const contents = {};
    if (output[_m] != null) {
        contents[_m] = (0,parse_utils.expectString)(output[_m]);
    }
    return contents;
};
...
const throwDefaultError = (0,default_error_handler.withBaseException)(STSServiceException);
const buildHttpRpcRequest = async (context, headers, path, resolvedHostname, body) => {
    ...
    return new httpRequest.HttpRequest(contents);
};
...
const buildFormUrlencodedString = (formEntries) => Object.entries(formEntries)
    .map(([key, value]) => (0,extended_encode_uri_component.extendedEncodeURIComponent)(key) + "=" + (0,extended_encode_uri_component.extendedEncodeURIComponent)(value))
    .join("&");
